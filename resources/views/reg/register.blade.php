        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">با ما فیت باشید 🚀</h4>
              <p class="mb-4">بدن خودت رو به ما بسپار</p>
                @if($errors->any())
                ...
                @endif
              <form id="formAuthentication" class="mb-3" action="{{Route('doregister')}}" method="post">
                  {{csrf_field()}}
                  <div class="mb-3">
                      <label for="email" class="form-label">نام و نام خانوادگی</label>
                      <input type="text" class="form-control" id="email" name="name" placeholder="نام و نام خانوادگی" />
                  </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="email" class="form-control" id="email" name="email" placeholder="ایمسل خود را وارد نمایید" />
                </div>
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="mb-3 form-password-toggle">
                      <label class="form-label" for="password2">رمز ورود</label>
                      <div class="input-group input-group-merge">
                          <input
                              type="password"
                              id="password2"
              ...
              <p class="text-center">
                <span>آیا شما حساب کاربری دارید</span>
                <a href="{{Route('login')}}">
                  <span>از اینجا وارد شوید</span>
                </a>
              </p>
            </div>
          </div>
